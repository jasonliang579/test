...
public class BankAccountActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_bank_account);
	...
	private void Init()
	{
		...
		String url = URLs.WEB_BAND_ACCOUNT;
		webView.loadUrl(url);
