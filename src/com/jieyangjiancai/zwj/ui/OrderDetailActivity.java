...
//		mMoney.setText("￥"+money);
	...
	private void GetData()
	{
		...
		mTextBeforeDiscount.setText("折前总额:￥9999");
		mTextDiscount.setText("折后总结:￥9999(8折)");
		mTextCoupon.setText("使用优惠券金额:￥9999");
		mTextPay.setText("实际总额:￥9999");
	}
	@Override
...
//				.inflate(R.layout.listview_header_receiver, null);
		LinearLayout  foot = (LinearLayout)LayoutInflater.from(this)
				.inflate(R.layout.listview_foot_orderdetail, null);
...
//		listview.addHeaderView(hearder);
		...
		mTextBeforeDiscount = (TextView)foot.findViewById(R.id.text_beforediscount);
		mTextDiscount = (TextView)foot.findViewById(R.id.text_discount);
		mTextCoupon = (TextView)foot.findViewById(R.id.text_coupon);
		mTextPay = (TextView)foot.findViewById(R.id.text_pay);
